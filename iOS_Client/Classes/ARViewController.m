...
//UIAccelerationValue rollingY, rollingZ;
...
- (void)accelerometer:(UIAccelerometer *)accelerometer didAccelerate:(UIAcceleration *)acceleration {
	...
	//NSLog(@"Inclination %f", RADIANS_TO_DEGREES (centerCoordinate.inclination));
...
- (void)updateLocations:(NSTimer *)timer {
	...
	//Vector3D tempVector = getGLVectorForARCoordinate(centerCoordinate);
	
	
	////NSLog(@"GLVector = (%f, %f, %f)", tempVector.x, tempVector.y, tempVector.z);
...
- (void)locationManager:(CLLocationManager *)manager didUpdateHeading:(CLHeading *)newHeading {
	...
	self.centerCoordinate.azimuth = fmod((newHeading.magneticHeading + 90), 360.0) * (2 * (M_PI / 360.0));
...
- (void)locationManager:(CLLocationManager *)manager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)oldLocation {
	...
	//NSLog(@"My position latitude: %f, longitude: %f", currentLocation.coordinate.latitude, currentLocation.coordinate.longitude);
